...
[Hostile]({{ site.baseurl }}/{% link modules/Host-Removal/_posts/2001-01-01-hostile.md %}) and [Deacon]({{ site.baseurl }}/{% link modules/Host-Removal/_posts/2001-01-01-deacon.md %}) are modern and robust tools for host removal. The first is based on alignment against the reference
