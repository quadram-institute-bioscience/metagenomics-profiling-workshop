...
![Profiling]({{ site.baseurl}}/{% link img/profiling.png %})


## Workshop Information

This hands-on workshop introduces taxonomic profiling methods for metagenomic sequencing data. 
You'll learn to profile microbial communities using MetaPhlAn4, Kraken2, and Bracken. 
...
**Workshop structure:** 
Theory and live demonstrations, followed by hands-on exploration of coffee fermentation microbiomes using R, and group discussion.
